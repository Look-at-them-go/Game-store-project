...
<div class="flex flex-row">
    ...
    <div class="flex flex-col w-1/2  p-3">
        @foreach ($comments as $comment)
            ...
            <form action="/admin/comment-delete/{{ $comment->id }}" method="get">
    ...
    <div>
        <form action="/admin/panel/export-user/{{ $user->id }}" method="get">
            @csrf
            <input  class="p-2 rounded hover:bg-indigo-300 cursor-pointer" type="submit" value="EXPORT USER DATA">
        </form>
    </div>
</div>
